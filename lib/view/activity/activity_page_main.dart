...
class _ActivityPageMainState extends State<ActivityPageMain> {
  ...
  late List<int> selectedIdx;

  @override
  void initState() {
    super.initState();
    changeHp = personalController.hpScore;
    selectedStates = List.generate(6, (index) => false);
    selectedIdx = [];
  }
  ...
  Widget _buildActionButtons() {
    return Row(
      ...
      children: [
        ...
        //참여하기버튼 이벤트
        TextButton(
          onPressed: _handleTakePartButton,
          child: Text(
