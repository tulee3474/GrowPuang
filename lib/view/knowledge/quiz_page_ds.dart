...
class QuizPageDs extends StatefulWidget {
  ...
  @override
  _QuizPageDsState createState() => _QuizPageDsState();
}

class _QuizPageDsState extends State<QuizPageDs> {
  String? selectedAnswer;
  late int addScore;
  late List<Map<String, Object>> questions = [
    {
      'questionText': widget.languageController.dsQuiz,
      'answers': [
        {'text': widget.languageController.dsQuizList[0], 'score': 5},
        {'text': widget.languageController.dsQuizList[1], 'score': 0},
        {'text': widget.languageController.dsQuizList[2], 'score': 0},
      ],
    },
    // 다른 퀴즈들 추가 가능
  ];
