...
class QuizPageOs extends StatefulWidget {
  ...
  @override
  _QuizPageOsState createState() => _QuizPageOsState();
}

class _QuizPageOsState extends State<QuizPageOs> {
  String? selectedAnswer;
  late int addScore;
  late List<Map<String, Object>> questions = [
    {
      'questionText': widget.languageController.osQuiz,
      'answers': [
        {'text': widget.languageController.osQuizList[0], 'score': 5},
        {'text': widget.languageController.osQuizList[1], 'score': 0},
        {'text': widget.languageController.osQuizList[2], 'score': 0},
      ],
    },
    // 다른 퀴즈들 추가 가능
  ];
                      ...
                      TextButton(
                        onPressed: () {
                          if(selectedAnswer == null){
                            ...
                            widget.personalController.solveQuizList.add(3); //문제를 제출하는 순간 푼 문제 목록에 들어간다
                            if(selectedAnswer == widget.languageController.osQuizList[2]){
                              addScore = 5;
