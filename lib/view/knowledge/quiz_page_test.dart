...
class _QuizPageTestState extends State<QuizPageTest> {
  String? selectedQuiz;
  List<Widget> whichQuizPage = [QuizPageDs(), QuizPageAlgor(), QuizPageSwe(), QuizPageOs(), QuizPagePl(), QuizPageCs()];
  late int addScore;
                            ...
                            onTap: () {
                              setState(
                                () {
                                  ...
                                  (lectures[0]['answers'] as List<Map<String, Object>>);

                                  selectedIndex = answersList.indexWhere((answer) {
