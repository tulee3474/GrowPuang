...
class QuizPageCs extends StatefulWidget {
  final personalController = Get.put(PersonalController());
  final languageController = Get.put(LanguageController());

  @override
  _QuizPageCsState createState() => _QuizPageCsState();
}

class _QuizPageCsState extends State<QuizPageCs> {
  String? selectedAnswer;
  late int addScore;
  late List<Map<String, Object>> questions = [
    {
      'questionText': widget.languageController.csQuiz,
      'answers': [
        {'text': widget.languageController.csQuizList[0], 'score': 5},
        {'text': widget.languageController.csQuizList[1], 'score': 0},
        {'text': widget.languageController.csQuizList[2], 'score': 0},
      ],
    },
    // 다른 퀴즈들 추가 가능
  ];
                      ...
                      TextButton(
                        onPressed: () {
                          if(selectedAnswer == null){
                            ...
                            widget.personalController.solveQuizList.add(5); //문제를 제출하는 순간 푼 문제 목록에 들어간다
                            if(selectedAnswer == widget.languageController.csQuizList[0]){
                              addScore = 5;
